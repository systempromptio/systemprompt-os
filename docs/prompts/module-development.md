 Referencing these rules, go one by one through the core modules until they are fully compliant, world class with 90% test coverage. '/var/www/html/systemprompt-os/src/modules/core'    
