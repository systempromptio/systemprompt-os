/**
 * @fileoverview Database backup command
...
export function createBackupCommand(db: DatabaseService, logger: Logger): Command {
...
async function cleanOldBackups(dir: string, retentionDays: number, logger: Logger): Promise<void> {
