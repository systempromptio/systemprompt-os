...
import type { DatabaseConfig, MigrationFile, QueryResult } from '../interfaces/database.interface.js';
...
export type { DatabaseConfig as DatabaseConfiguration } from '../interfaces/database.interface.js';

/**
 * Dependency injection tokens
 */
import { Token } from 'typedi';
import type { IDatabaseService } from './db-service.interface.js';
export const DATABASE_TOKEN = new Token<IDatabaseService>('core.database');