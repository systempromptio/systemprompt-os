...
export class MCPRegistryService {
  ...
  private readonly modules: Map<string, MCPModule> = new Map();
  ...
  registerTool(tool: MCPTool, moduleId?: string): void {
    ...
    // Add module ID to metadata (store it separately for now)
    if (moduleId) {
      // Store module ID association separately
      // TODO: Add proper module tracking
    }
