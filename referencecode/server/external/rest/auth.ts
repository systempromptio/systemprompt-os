...
export function setupRoutes(router: Router): void {
  ...
  router.get('/auth', async (req, res) => authEndpoint.handleAuthPage(req, res));
  router.get('/auth/callback', async (req, res) => authEndpoint.handleAuthCallback(req, res));
  router.post('/auth/logout', async (req, res) => authEndpoint.handleLogout(req, res));
}
