...
import { serverConfig, serverCapabilities } from './mcp/config.js';
...
import { handleListPrompts, handleGetPrompt } from './mcp/core/handlers/prompt-handlers.js';
import { handleListResources, handleResourceCall } from './mcp/core/handlers/resource-handlers.js';
import { handleListResourceTemplates } from './mcp/core/handlers/resource-templates-handler.js';
import { handleListRoots } from './mcp/core/handlers/roots-handlers.js';
import { handleListTools, handleToolCall } from './mcp/core/handlers/tool-handlers.js';
...
export class MCPHandler implements IMCPHandler {
  ...
  private readonly SESSIONTIMEOUT_MS = 60 * 60 * 1000;
  ...
  async setupRoutes(app: express.Application): Promise<void> {
    ...
    app.all('/mcp', ...mcpMiddleware, async (req, res) => this.handleRequest(req, res));
  }
