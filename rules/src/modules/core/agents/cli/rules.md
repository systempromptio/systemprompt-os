...
- `{module}.module.generated.ts` - Create/Update data schemas
...
```typescript
import { UserUpdateDataSchema } from '../types/{module}.module.generated';
...
```typescript
// In {module}/utils/cli-validation.ts
import { z } from 'zod';
import { CliOutputService } from '@/modules/core/cli/services/cli-output.service';
import { 
  UserCreateDataSchema,
...
3. **Type Generation**:
   - Run `./bin/systemprompt dev generate-types {module}` after schema changes
