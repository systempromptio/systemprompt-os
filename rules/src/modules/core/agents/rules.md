...
import { {Module}ModuleExportsSchema } from './types/{module}.module.generated';
...
- `{module}.module.generated.ts` - Generated domain interfaces and Zod schemas from service methods
...
3. **CLI Commands**
   ...
   - See `/var/www/html/systemprompt-os/rules/src/modules/core/{module}/cli/rules.md`
...
export class {Module}Repository {
  async create(data: I{Module}CreateData): Promise<I{Module}> {
    const result = await this.db.query(
      `INSERT INTO {module} (...) VALUES (...) RETURNING *`,
      [...]
    );
