...
- **Example**: `I{Module}Row`, `{Module}Status` enum
...
- **Example**: `I{Entity}`, `I{Module}Service`, `I{Module}ModuleExports`
...
- **Example**: `{Module}ServiceSchema`, `{Module}ModuleExportsSchema`
...
import type { I{Entity} } from './permissions.module.generated';

export interface Cli{Entity}DisplayFormat {
  {entity}: I{Entity};
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface Cli{Entity}SearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { I{Entity}, I{Module}Service } from '@/modules/core/permissions/types/permissions.module.generated';
...
import { {Module}ServiceSchema } from '@/modules/core/permissions/types/permissions.service.generated';
```

### External Type Usage
```typescript
// In services
import type { I{Entity} } from '@/modules/core/permissions/types/permissions.module.generated';

// In repositories  
import type { I{Module}Row } from '@/modules/core/permissions/types/database.generated';
...
export interface I{Module}ModuleExports {
  readonly service: () => I{Module}Service;
}
```
