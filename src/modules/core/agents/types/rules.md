...
- **Example**: `IAgentsRow`, `AgentsStatus` enum

### agents.module.generated.ts
...
- **Example**: `IAgent`, `IAgentsService`, `IAgentsModuleExports`

### agents.service.generated.ts
...
- **Example**: `AgentsServiceSchema`, `AgentsModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts agents
   ```
...
import type { IAgent } from './agents.module.generated';

export interface CliAgentDisplayFormat {
  agent: IAgent;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliAgentSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IAgent, IAgentsService } from '@/modules/core/agents/types/agents.module.generated';
...
import { AgentsServiceSchema } from '@/modules/core/agents/types/agents.service.generated';
```
...
```typescript
// Auto-generated in agents.module.generated.ts
export interface IAgentsModuleExports {
  readonly service: () => IAgentsService;
}
```
