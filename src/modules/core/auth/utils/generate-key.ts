 ...
 */
const generateRsaKeyPair = (algorithm: 'RS256' | 'RS512'): { publicKey: string; privateKey: string } => {
 ...
 * @returns Object containing public and private keys
 */
const generateEcKeyPair = (algorithm: 'ES256' | 'ES512'): { publicKey: string; privateKey: string } => {
 ...
 * @param options - Configuration options for key generation including algorithm, output directory, and format
 */
