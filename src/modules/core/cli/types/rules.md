...
- **Example**: `ICliRow`, `CliStatus` enum
...
- **Example**: `ICli`, `ICliService`, `ICliModuleExports`
...
- **Example**: `CliServiceSchema`, `CliModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts cli
   ```
...
import type { ICli } from './cli.module.generated';

export interface CliCliDisplayFormat {
  cli: ICli;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliCliSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { ICli, ICliService } from '@/modules/core/cli/types/cli.module.generated';

// Import database types
import type { ICliRow, CliStatus } from '@/modules/core/cli/types/database.generated';

// Import service schemas for validation
import { CliServiceSchema } from '@/modules/core/cli/types/cli.service.generated';
```

### External Type Usage
```typescript
// In services
import type { ICli } from '@/modules/core/cli/types/cli.module.generated';

// In repositories  
import type { ICliRow } from '@/modules/core/cli/types/database.generated';
...
```typescript
// Auto-generated in cli.module.generated.ts
export interface ICliModuleExports {
  readonly service: () => ICliService;
}
```
