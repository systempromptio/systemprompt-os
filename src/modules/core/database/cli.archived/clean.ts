/**
 * @file Clean old/unused data command.
...
export function createCleanCommand(db: DatabaseService, logger: ILogger): Command {
  return new Command('clean')
    ...
    .action(async (options) => {
      try {
        ...
        if (!Object.values(cleanTargets).some((v) => { return v })) {
