/**
 * @file Database data migration command for migrating data between versions.
 ...
 */
export function createDataMigrateCommand(service: DatabaseService, logger?: ILogger): Command {
