...
- **Example**: `IDatabaseRow`, `DatabaseStatus` enum

### database.module.generated.ts
...
- **Example**: `IDatabase`, `IDatabaseService`, `IDatabaseModuleExports`

### database.service.generated.ts
...
- **Example**: `DatabaseServiceSchema`, `DatabaseModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts database
   ```
...
import type { IDatabase } from './database.module.generated';

export interface CliDatabaseDisplayFormat {
  database: IDatabase;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliDatabaseSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IDatabase, IDatabaseService } from '@/modules/core/database/types/database.module.generated';
...
import { DatabaseServiceSchema } from '@/modules/core/database/types/database.service.generated';
```

### External Type Usage
```typescript
// In services
import type { IDatabase } from '@/modules/core/database/types/database.module.generated';

// In repositories  
import type { IDatabaseRow } from '@/modules/core/database/types/database.generated';
...
```typescript
// Auto-generated in database.module.generated.ts
