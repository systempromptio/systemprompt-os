...
- **MUST** follow the exact pattern:
  ...
  export const devCommands = {
    name: 'dev',
    alias: '{shortname}',  
    description: 'Dev module commands',
...
export const command: ICLICommand = {
  ...
  execute: async (context: ICLIContext): Promise<void> => {
    ...
    try {
      ...
      logger.error(LogSource.DEV, 'Command failed', { error });
      process.exit(1);
    }
  },
};
...
- `dev.module.generated.ts` - Create/Update data schemas
- `dev.service.generated.ts` - Service method schemas
...
} from '../types/dev.module.generated';
...
```typescript
import { UserUpdateDataSchema } from '../types/dev.module.generated';
...
```typescript
// In dev/utils/cli-validation.ts
import { z } from 'zod';
import { CliOutputService } from '@/modules/core/cli/services/cli-output.service';
import { 
  UserCreateDataSchema,
...
3. **Type Generation**:
   - Run `./bin/systemprompt dev generate-types dev` after schema changes
