...
export class ExtensionInstallationError extends ExtensionError {
  constructor(message: string, details?: string) {
    super(
      details ? `Extension installation failed: ${message} - ${details}` : `Extension installation failed: ${message}`,
...
export class ExtensionConfigError extends ExtensionError {
  constructor(message: string, configPath?: string) {
    super(
      configPath ? `Invalid extension configuration at ${configPath}: ${message}` : `Invalid extension configuration: ${message}`,
