...
- **Example**: `ILoggerRow`, `LoggerStatus` enum

### logger.module.generated.ts
...
- **Example**: `ILogger`, `ILoggerService`, `ILoggerModuleExports`

### logger.service.generated.ts
...
- **Example**: `LoggerServiceSchema`, `LoggerModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts logger
   ```
...
import type { ILogger } from './logger.module.generated';

export interface CliLoggerDisplayFormat {
  logger: ILogger;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliLoggerSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { ILogger, ILoggerService } from '@/modules/core/logger/types/logger.module.generated';
...
import { LoggerServiceSchema } from '@/modules/core/logger/types/logger.service.generated';
```

### External Type Usage
```typescript
// In services
import type { ILogger } from '@/modules/core/logger/types/logger.module.generated';

// In repositories  
import type { ILoggerRow } from '@/modules/core/logger/types/database.generated';
...
```typescript
// Auto-generated in logger.module.generated.ts
export interface ILoggerModuleExports {
  readonly service: () => ILoggerService;
}
```
