...
export const command: ICLICommand = {
  ...
  execute: async (context: ICLIContext): Promise<void> => {
    ...
    try {
      ...
      logger.error(LogSource.MCP, 'Command failed', { error });
      process.exit(1);
    }
  },
};
...
- `mcp.module.generated.ts` - Create/Update data schemas
- `mcp.service.generated.ts` - Service method schemas
...
```typescript
import { UserUpdateDataSchema } from '../types/mcp.module.generated';
...
```typescript
// In mcp/utils/cli-validation.ts
import { z } from 'zod';
import { CliOutputService } from '@/modules/core/cli/services/cli-output.service';
import { 
  UserCreateDataSchema,
...
3. **Type Generation**:
   - Run `./bin/systemprompt dev generate-types mcp` after schema changes
