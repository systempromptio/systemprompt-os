...
- **Example**: `IMcpRow`, `McpStatus` enum

### mcp.module.generated.ts
...
- **Example**: `IMcp`, `IMcpService`, `IMcpModuleExports`

### mcp.service.generated.ts
...
- **Example**: `McpServiceSchema`, `McpModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts mcp
   ```
...
import type { IMcp } from './mcp.module.generated';

export interface CliMcpDisplayFormat {
  mcp: IMcp;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliMcpSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IMcp, IMcpService } from '@/modules/core/mcp/types/mcp.module.generated';

// Import database types
import type { IMcpRow, McpStatus } from '@/modules/core/mcp/types/database.generated';

// Import service schemas for validation
import { McpServiceSchema } from '@/modules/core/mcp/types/mcp.service.generated';
```

### External Type Usage
```typescript
// In services
import type { IMcp } from '@/modules/core/mcp/types/mcp.module.generated';

// In repositories  
import type { IMcpRow } from '@/modules/core/mcp/types/database.generated';
...
```typescript
// Auto-generated in mcp.module.generated.ts
export interface IMcpModuleExports {
  readonly service: () => IMcpService;
}
```
