...
- **Example**: `IModulesRow`, `ModulesStatus` enum

### modules.module.generated.ts
...
- **Example**: `IModule`, `IModulesService`, `IModulesModuleExports`

### modules.service.generated.ts
...
- **Example**: `ModulesServiceSchema`, `ModulesModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts modules
   ```
...
import type { IModule } from './modules.module.generated';

export interface CliModuleDisplayFormat {
  module: IModule;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliModuleSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IModule, IModulesService } from '@/modules/core/modules/types/modules.module.generated';
...
import { ModulesServiceSchema } from '@/modules/core/modules/types/modules.service.generated';
```

### External Type Usage
```typescript
// In services
import type { IModule } from '@/modules/core/modules/types/modules.module.generated';
...
```typescript
// Auto-generated in modules.module.generated.ts
export interface IModulesModuleExports {
  readonly service: () => IModulesService;
}
```
