...
- **Example**: `IPermissionsRow`, `PermissionsStatus` enum

### permissions.module.generated.ts
...
- **Example**: `IPermission`, `IPermissionsService`, `IPermissionsModuleExports`

### permissions.service.generated.ts
...
- **Example**: `PermissionsServiceSchema`, `PermissionsModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts permissions
   ```
...
import type { IPermission } from './permissions.module.generated';

export interface CliPermissionDisplayFormat {
  permission: IPermission;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliPermissionSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IPermission, IPermissionsService } from '@/modules/core/permissions/types/permissions.module.generated';
...
import { PermissionsServiceSchema } from '@/modules/core/permissions/types/permissions.service.generated';
```

### External Type Usage
```typescript
// In services
import type { IPermission } from '@/modules/core/permissions/types/permissions.module.generated';

// In repositories  
import type { IPermissionsRow } from '@/modules/core/permissions/types/database.generated';
...
```typescript
// Auto-generated in permissions.module.generated.ts
