...
- **Example**: `ISystemRow`, `SystemStatus` enum

### system.module.generated.ts
...
- **Example**: `ISystem`, `ISystemService`, `ISystemModuleExports`

### system.service.generated.ts
...
- **Example**: `SystemServiceSchema`, `SystemModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts system
   ```
...
import type { ISystem } from './system.module.generated';

export interface CliSystemDisplayFormat {
  system: ISystem;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliSystemSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { ISystem, ISystemService } from '@/modules/core/system/types/system.module.generated';
...
import { SystemServiceSchema } from '@/modules/core/system/types/system.service.generated';
```

### External Type Usage
```typescript
// In services
import type { ISystem } from '@/modules/core/system/types/system.module.generated';

// In repositories  
import type { ISystemRow } from '@/modules/core/system/types/database.generated';
...
```typescript
// Auto-generated in system.module.generated.ts
export interface ISystemModuleExports {
  readonly service: () => ISystemService;
}
```
