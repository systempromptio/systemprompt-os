...
import type { ITaskRow, TaskStatus } from './database.generated';

// Re-export autogenerated types
export type { ITaskRow, ITaskMetadataRow } from './database.generated';
export { TaskStatus } from './database.generated';
