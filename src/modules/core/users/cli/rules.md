...
./bin/systemprompt users {command}
...
- `users.module.generated.ts` - Create/Update data schemas
- `users.service.generated.ts` - Service method schemas
...
```typescript
import { UserUpdateDataSchema } from '../types/users.module.generated';
...
```typescript
// In users/utils/cli-validation.ts
import { z } from 'zod';
import { CliOutputService } from '@/modules/core/cli/services/cli-output.service';
import { 
  UserCreateDataSchema,
...
3. **Type Generation**:
   - Run `./bin/systemprompt dev generate-types users` after schema changes
