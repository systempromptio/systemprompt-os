...
- `repositories/` - Data access layer
  - `users.repository.ts` - Repository implementation
...
### index.ts Structure
- Must extend `BaseModule<IUsersModuleExports>`
...
- Location: `/tests/integration/modules/core/users/users.integration.test.ts`
...
- `users.module.generated.ts` - Generated domain interfaces and module exports from service methods
- `users.service.generated.ts` - Generated service validation schemas from TypeScript AST
...
npx tsx src/modules/core/dev/cli/generate-types.ts users
```
