...
- **Example**: `IUsersRow`, `UsersStatus` enum

### users.module.generated.ts
...
- **Example**: `IUser`, `IUsersService`, `IUsersModuleExports`

### users.service.generated.ts
...
- **Example**: `UsersServiceSchema`, `UsersModuleExportsSchema`
...
import type { IUser } from './users.module.generated';

export interface CliUserDisplayFormat {
  user: IUser;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliUserSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IUser, IUsersService } from '@/modules/core/users/types/users.module.generated';
...
import { UsersServiceSchema } from '@/modules/core/users/types/users.service.generated';
```
...
```typescript
// Auto-generated in users.module.generated.ts
