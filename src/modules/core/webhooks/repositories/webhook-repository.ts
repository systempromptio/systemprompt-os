...
export class WebhookRepository {
  ...
  async getWebhookStats(webhookId: string): Promise<WebhookStats> {
    ...
    return {
      ...
      last_delivery: stats.last_delivery ? new Date(stats.last_delivery) : undefined,
      last_success: stats.last_success ? new Date(stats.last_success) : undefined,
      last_failure: stats.last_failure ? new Date(stats.last_failure) : undefined,
