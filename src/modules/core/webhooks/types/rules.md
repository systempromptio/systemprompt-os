...
- **Example**: `IWebhooksRow`, `WebhooksStatus` enum

### webhooks.module.generated.ts
...
- **Example**: `IWebhook`, `IWebhooksService`, `IWebhooksModuleExports`

### webhooks.service.generated.ts
...
- **Example**: `WebhooksServiceSchema`, `WebhooksModuleExportsSchema`
...
3. **Manual regeneration** via CLI command:
   ```bash
   npx tsx src/modules/core/dev/cli/generate-types.ts webhooks
   ```
...
import type { IWebhook } from './webhooks.module.generated';

export interface CliWebhookDisplayFormat {
  webhook: IWebhook;
  displayFormat: 'table' | 'json' | 'compact';
  includeMetadata: boolean;
}

export interface CliWebhookSearchOptions {
  query: string;
  limit?: number;
  format?: 'table' | 'json';
}
...
import type { IWebhook, IWebhooksService } from '@/modules/core/webhooks/types/webhooks.module.generated';
...
import { WebhooksServiceSchema } from '@/modules/core/webhooks/types/webhooks.service.generated';
```

### External Type Usage
```typescript
// In services
import type { IWebhook } from '@/modules/core/webhooks/types/webhooks.module.generated';

// In repositories  
import type { IWebhooksRow } from '@/modules/core/webhooks/types/database.generated';
...
```typescript
// Auto-generated in webhooks.module.generated.ts
export interface IWebhooksModuleExports {
  readonly service: () => IWebhooksService;
}
```
