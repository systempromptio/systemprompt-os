 ...
 * Generated on: 2025-08-02T11:28:24.763Z
...
import type { ITasksModuleExports } from '@/modules/core/tasks/types/manual';
import type { IMonitorModuleExports } from '@/modules/core/monitor/types/manual';
...
import type { IEventsModuleExports } from '@/modules/core/events/types/manual';
import type { ICLIModuleExports } from '@/modules/core/cli/types/manual';
...
export const isModulesModuleExports = (
  ...
  return candidate?.name === ModuleName.MODULES
    ...
    && typeof candidate.exports.getAllModules === 'function'
    ...
    && typeof candidate.exports.setupInstall === 'function'
    && typeof candidate.exports.setupClean === 'function'
    && typeof candidate.exports.setupUpdate === 'function'
    && typeof candidate.exports.setupValidate === 'function'
    && typeof candidate.exports.healthCheck === 'function';
};
