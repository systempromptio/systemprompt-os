 ...
 * Generated on: 2025-07-31T10:53:14.412Z
...
import type { IAgentsModuleExports } from '@/modules/core/agents/types/agent.types';
...
export const isModulesModuleExports = (
  ...
  return candidate?.name === ModuleName.MODULES
    ...
    && candidate.exports.registerCoreModule !== undefined
    && candidate.exports.path !== undefined
    && (!candidate.exports.dependencies || typeof candidate.exports.dependencies === 'object')
    ...
    && candidate.exports.registerPreLoadedModule !== undefined
    && typeof candidate.exports.module === 'function'
...
export const isConfigModuleExports = (
  ...
  return candidate?.name === ModuleName.CONFIG
    ...
    && candidate.exports.set !== undefined
    && typeof candidate.exports.value === 'function';
};
...
export const isCLIModuleExports = (
  ...
  return candidate?.name === ModuleName.CLI
    && Boolean(candidate.exports)
    && typeof candidate.exports === 'object'
    && candidate.exports.commandName !== undefined
    && candidate.exports.commands !== undefined
    && candidate.exports.commands !== undefined
    && candidate.exports.format !== undefined
    && candidate.exports.commands !== undefined
    && candidate.exports.format !== undefined;
};
