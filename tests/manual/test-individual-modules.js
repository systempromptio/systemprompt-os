...
/**
 * Test individual core module creation and initialization
 * This test verifies that each core module can be loaded and initialized in isolation
 */
...
async function testModule(moduleDef) {
...
async function main() {
  ...
  for (const moduleDef of coreModules) {
    const result = await testModule(moduleDef);
