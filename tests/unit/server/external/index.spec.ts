...
describe('External API Setup', () => {
  ...
  it('should set up all external endpoints', async () => {
    ...
    const { setupRoutes: setupConfigRoutes, setupPublicRoutes } = await import('@/server/external/rest/config.js');
  ...
  it('should handle health endpoint requests', async () => {
    ...
    vi.mocked(await import('@/server/external/rest/health.js')).HealthEndpoint.mockImplementation(() => mockHealthInstance as any);
