...
const sourceFile = resolve(__dirname, '../../../../../../../src/server/mcp/core/handlers/prompts/unit-testing.ts');
...
if (fileExists) {
  try {
    mockExports = await import('../../../../../../../src/server/mcp/core/handlers/prompts/unit-testing');
  } catch (error) {
    console.warn('Failed to import unit-testing module:', error);
  }
}

describeSkip('Unit Testing Prompts', () => {
